...
differences are randomly — if there is no difference, then we can flip
the before / after (A / B) pairs and be in the same world.

Notice though the flipping the before / after or A / B in the pair just
changes the sign of the difference.

So we will simulate that effect, of flipping the values in the pair, by
